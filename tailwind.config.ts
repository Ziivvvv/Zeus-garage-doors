...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        card: "0 2px 16px 0 rgba(27, 42, 59, 0.08), 0 1px 4px 0 rgba(27, 42, 59, 0.04)",
        "card-hover": "0 8px 32px 0 rgba(27, 42, 59, 0.14), 0 2px 8px 0 rgba(27, 42, 59, 0.06)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
