...
const DIRECT_ANSWER =
  "Zeus Garage Doors provides same-day garage door repair in Woodinville, WA — specializing in heavy-duty spring replacement, custom wood door service, opener repair, off-track repair, and full new installations. Based in neighboring Kirkland, we serve Hollywood Hill, Cottage Lake, Wellington, and every Woodinville neighborhood with the same same-day commitment we give our home market. Call 425-448-6443.";
...
const WOODINVILLE_FAQS = [
  ...
  },
  {
    ...
    answer:
      "Turn off power to the opener and stop using the door immediately. A broken spring makes the door extremely heavy and unsafe to operate — forcing it risks damaging the opener, cables, and tracks. Call Zeus Garage Doors at 425-448-6443. We stock torsion and extension springs in over 10 sizes on every truck and complete most Woodinville spring replacements in a single same-day visit.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. Same-day service in Woodinville is standard for us, not an upgrade tier. We are available Sunday through Thursday 6:00 AM–10:00 PM (PT) and Friday 6:00 AM–6:00 PM (PT). Saturday is our only closed day. For urgent calls — broken springs, doors stuck open, cables snapped — we prioritize Woodinville dispatch directly from our Kirkland base.",
  },
  {
    question: "Do you offer emergency garage door service after hours in Woodinville?",
    answer:
      "Yes. While our standard business hours are Sunday–Thursday 6:00 AM–10:00 PM (PT) and Friday 6:00 AM–6:00 PM (PT) (Saturday closed), Zeus Garage Doors provides specialized emergency dispatch outside of regular business hours for urgent repairs in Woodinville. If a spring snaps overnight, your door is stuck open, or you have a security concern that cannot wait — call 425-448-6443 and our team will arrange emergency service. After-hours emergency dispatch is available Sunday through Thursday nights only — not Friday nights or Saturday.",
  },
];
...
export default function WoodinvilleLocation() {
  return (
    <>
      <SEOHead
        title="Garage Door Repair Woodinville WA | Zeus Garage Doors"
        description="Expert garage door repair in Woodinville, WA. Springs, openers, off-track & new installations. Same-day Kirkland-based service. Call 425-448-6443."
            ...
            <FadeIn>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gold/8 border-l-4 border-gold rounded-r-2xl p-6">
                  ...
                  >
                    📞 Call 425-448-6443 for same-day spring service →
                  </a>
                </div>
